            ...
            <div class="z-index-1 py-1 light">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <h5 class="text-white mb-0 me-2"><svg class="svg-inline--fa fa-palette fa-w-16 me-2 fs-0"
                        ...
                        <!-- <span class="fas fa-palette me-2 fs-0"></span> Font Awesome fontawesome.com -->Settings
                        ...
                        style="font-size:12px"> <svg class="svg-inline--fa fa-redo-alt fa-w-16 me-1"
                            ...
                            data-icon="redo-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        ...
                        <!-- <span class="fas fa-redo-alt me-1" data-fa-transform="shrink-3"></span> Font Awesome fontawesome.com -->Reset</button>
                </div>
                                ...
                                <div class="btn-group d-block w-100 btn-group-navbar-style">
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-6"><input class="btn-check" id="themeSwitcherDark"
                                                name="theme-color" type="radio" value="dark" data-theme-control="theme"
                                    ...
                                    <div class="row gx-2">
                                        ...
                                        <div class="col-6"><input class="btn-check" id="navbar-style-card" type="radio"
                                                ...
                                                for="navbar-style-card"> <img class="img-fluid img-prototype"
                                                    src="assets/img/generic/card.png" alt=""><span class="label-text">
                                                    Card</span></label></div>
