                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link dropdown-indicator" href="#email" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="d-flex align-items-center"><span class="nav-link-icon"><svg
                                ...
                                <!-- <span class="fas fa-envelope-open"></span> Font Awesome fontawesome.com --></span>
                                <span
                                class="nav-link-text ps-1">Tailoring</span>
                            </div>
                    </a>
                    <ul class="nav collapse" id="email">
                        {{-- {{ route('admin.category.index') }} --}}
                        <li class="nav-item"><a class="nav-link" href="{{ route('admin.personaldetail.index') }}">
                                <div class="d-flex align-items-center"><span
                                        class="nav-link-text ps-1">Personal Detail</span></div>
                            </a><!-- more inner pages-->
                        </li>
                        {{-- {{ route('admin.customer.index') }} --}}
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.measurementdetail.index') }}">
                                <div class="d-flex align-items-center"><span class="nav-link-text ps-1">                                      Measurement Detail</span>
                                </div>
                            </a><!-- more inner pages-->
                        </li>
